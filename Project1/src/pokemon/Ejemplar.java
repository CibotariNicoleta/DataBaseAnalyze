...
public class Ejemplar {
	...
	public static String toStringArrayList(ArrayList<Ejemplar> especies) {
		String result = "\nNúmero - Nombre - Descripción - Evoluciona de\n";
		
		for (Ejemplar e: especies) {
			result += e.getN_pokedex() + " - ";
			result += e.getN_encuentro() + " - ";
			result += e.getNivel() + " \n ";
